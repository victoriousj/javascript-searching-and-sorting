...
let sortedNames = quickSort.sort(names.unsortedNames);
for (let i = 0; i < oneHundredNames.length; i++) {
  const indexFoundAt = binarySearch.search(sortedNames, oneHundredNames[i]);
  console.log(`${oneHundredNames[i]} found at index ${indexFoundAt}`);
}
